...
from strategy.mcts_prog import MCTSStrategyProg
...
if __name__ == "__main__":
    ...
    while engine.has_game_ended() == 0:
        if active_player == 1:
            ...
            active_player = engine.apply_strategy(MCTSStrategyProg(active_player, engine.get_current_board()), active_player)
        print()
        engine.print_board()
